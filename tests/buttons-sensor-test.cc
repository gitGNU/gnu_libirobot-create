...
int run_test (iRobot::Create robot, std::stringstream& stream)
{
  ...
  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 0,
                      !!robot.advanceButton ()
                      || !!robot.playButton ());

  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 1,
                      !!robot.advanceButton ()
                      || !robot.playButton ());

  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 2,
                      !!robot.advanceButton ()
                      || !!robot.playButton ());

  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 3,
                      !!robot.advanceButton ()
                      || !robot.playButton ());

  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 4,
                      !robot.advanceButton ()
                      || !!robot.playButton ());

  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 5,
                      !robot.advanceButton ()
                      || !robot.playButton ());

  CHECK_SENSOR_UCHAR (Create::SENSOR_BUTTONS, 8,
                      !!robot.advanceButton ()
                      || !!robot.playButton ());
